...
UNTIL NOW! 
Over the past week or so, me and HexagonMIDIs have been working on something called "aPFA" or "Android PFA" that intends to be a direct replication of PFAs engine to Android! It's in a state to where I'm confident enough in saying that you could legit run on your phone in good faith!

aPFAs current features as of **v1.0.1** are:
